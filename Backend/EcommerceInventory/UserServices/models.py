...
class Users(AbstractUser):
    ...
    role=models.CharField(max_length=50,blank=True,null=True,default='Admin',choices=(('Admin','Admin'),('Supplier','Supplier'),('Customer','Customer'),('Staff','Staff'), ('SuperAdmin','SuperAdmin')))
    ...
    domain_user_id=models.ForeignKey('self',on_delete=models.CASCADE,blank=True,null=True,db_column='domain_user_id',related_name='domain_user_id_user')
    ...
    added_by_user_id=models.ForeignKey('self',on_delete=models.CASCADE,blank=True,null=True,db_column='added_by_user_id',related_name='added_by_user_id_user')
...
class Modules(models.Model):
    ...
    parent_id=models.ForeignKey('self',on_delete=models.CASCADE,blank=True,null=True,db_column='parent_id',related_name='children')
...
class UserPermissions(models.Model):
    ...
    domain_user_id=models.ForeignKey(Users,on_delete=models.CASCADE,blank=True,null=True,db_column='domain_user_id',related_name='domain_user_id_user_permissions')
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
...
class ActivityLog(models.Model):
    ...
    domain_user_id=models.ForeignKey(Users,on_delete=models.CASCADE,blank=True,null=True,db_column='domain_user_id',related_name='domain_user_id_activity_log')
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)